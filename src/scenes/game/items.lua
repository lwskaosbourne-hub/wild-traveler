items = {{name = "Sword",       type="equipment", class="sword",   index_x = 1, index_y = 0, maximum_coupling = 1},
        ...
        {name = "Pickaxe",      type="equipment", class="pickaxe", index_x = 3, index_y = 1, maximum_coupling = 1},
        ...
        {name = "Rock",         type="material",  class="rock",    index_x = 4, index_y = 1, maximum_coupling = 99},
}
